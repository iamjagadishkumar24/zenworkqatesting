...
// Per-accent preview tokens used by the side-by-side comparison grid.
// Values mirror the CSS variables defined in src/styles.css so the preview
// tiles stay visually faithful without depending on root cascade overrides.
const ACCENT_PREVIEW: Record<
  NonNullable<AdminPrefs["accent"]>,
  {
    primary: string;
    primaryFg: string;
    surface: string;
...
> = {
  light: {
    primary: "oklch(0.55 0.02 255)",
    primaryFg: "oklch(0.99 0 0)",
    surface: "oklch(0.99 0.005 255)",
    surfaceBorder: "oklch(0.9 0.01 255)",
    text: "oklch(0.22 0.02 255)",
    muted: "oklch(0.55 0.02 255)",
    accentSoft: "oklch(0.94 0.02 255)",
  },
  blue: {
    primary: "oklch(0.55 0.2 255)",
    primaryFg: "oklch(0.99 0 0)",
    surface: "oklch(0.99 0.01 255)",
    surfaceBorder: "oklch(0.88 0.04 255)",
    text: "oklch(0.22 0.04 255)",
    muted: "oklch(0.5 0.04 255)",
    accentSoft: "oklch(0.94 0.04 255)",
  },
  green: {
    primary: "oklch(0.6 0.18 145)",
    primaryFg: "oklch(0.99 0 0)",
    surface: "oklch(0.99 0.01 145)",
    surfaceBorder: "oklch(0.88 0.04 145)",
    text: "oklch(0.22 0.04 145)",
    muted: "oklch(0.5 0.04 145)",
    accentSoft: "oklch(0.94 0.04 145)",
  },
  teal: {
    primary: "oklch(0.62 0.13 195)",
    primaryFg: "oklch(0.99 0 0)",
    surface: "oklch(0.99 0.01 195)",
    surfaceBorder: "oklch(0.88 0.04 195)",
    text: "oklch(0.22 0.04 195)",
    muted: "oklch(0.5 0.04 195)",
    accentSoft: "oklch(0.94 0.04 195)",
  },
  purple: {
    primary: "oklch(0.55 0.22 295)",
    primaryFg: "oklch(0.99 0 0)",
    surface: "oklch(0.99 0.01 295)",
    surfaceBorder: "oklch(0.88 0.04 295)",
    text: "oklch(0.22 0.04 295)",
    muted: "oklch(0.5 0.04 295)",
    accentSoft: "oklch(0.94 0.04 295)",
  },
  pink: {
    primary: "oklch(0.66 0.22 340)",
    primaryFg: "oklch(0.99 0 0)",
    surface: "oklch(0.99 0.01 340)",
    surfaceBorder: "oklch(0.88 0.04 340)",
    text: "oklch(0.22 0.04 340)",
    muted: "oklch(0.5 0.04 340)",
    accentSoft: "oklch(0.94 0.04 340)",
  },
  orange: {
    primary: "oklch(0.66 0.18 55)",
    primaryFg: "oklch(0.99 0 0)",
    surface: "oklch(0.99 0.01 55)",
    surfaceBorder: "oklch(0.88 0.04 55)",
    text: "oklch(0.22 0.04 55)",
    muted: "oklch(0.5 0.04 55)",
    accentSoft: "oklch(0.94 0.04 55)",
  },
  grey: {
    primary: "oklch(0.5 0.02 255)",
    primaryFg: "oklch(0.99 0 0)",
    surface: "oklch(0.99 0.005 255)",
    surfaceBorder: "oklch(0.9 0.01 255)",
    text: "oklch(0.22 0.01 255)",
    muted: "oklch(0.5 0.01 255)",
    accentSoft: "oklch(0.94 0.01 255)",
  },
};

function AccentPreviewTile({
  label,
  active,
  tokens,
  onApply,
  ...
  label: string;
  active: boolean;
  tokens: (typeof ACCENT_PREVIEW)[NonNullable<AdminPrefs["accent"]>];
  onApply: () => void;
}) {
  return (
    <div
    ...
    >
      <div
        ...
        style={{ borderColor: tokens.surfaceBorder, background: tokens.accentSoft }}
      >
        <span className="text-xs font-semibold uppercase tracking-wide">{label}</span>
        {active ? (
          <span
            className="text-[10px] font-medium px-1.5 py-0.5 rounded"
            style={{ background: tokens.primary, color: tokens.primaryFg }}
          >
            Current
          </span>
        ) : null}
      ...
      <div className="p-3 space-y-2">
        <div className="flex items-center gap-2">
          ...
          <span
            ...
            style={{ background: tokens.accentSoft, color: tokens.primary }}
          >
            Badge
          </span>
          <span className="text-[11px] underline" style={{ color: tokens.primary }}>
            Link
          </span>
        </div>
        ...
        <div className="flex items-end gap-1 h-6">
          {[0.4, 0.7, 0.55, 0.9, 0.5].map((h, i) => (
            <span
              key={i}
              className="flex-1 rounded-sm"
              style={{ background: tokens.primary, opacity: 0.4 + h * 0.6, height: `${h * 100}%` }}
            />
          ))}
        </div>
        <button
          type="button"
          onClick={onApply}
          className="w-full text-xs font-medium rounded-md py-1.5 transition-opacity hover:opacity-90"
          style={{ background: tokens.primary, color: tokens.primaryFg }}
        >
