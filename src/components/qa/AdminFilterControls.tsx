...
function UnauthorizedFilterNotice({
  ...
  const label =
    scope === "defect" ? "Cross-agent defect filters are admin-only" : "Admin-only audit filters";
  const detail =
    scope === "defect"
  ...
  return (
    <div data-testid="admin-defect-filters" className="contents">
      ...
      <FilterSelect
        ariaLabel="Comments"
        value={v.hasComments}
        onChange={(x) => o.hasComments(x as Presence)}
      ...
      <FilterSelect
        ...
        value={v.hasAttach}
        onChange={(x) => o.hasAttach(x as Presence)}
      ...
      <FilterSelect
        ariaLabel="Retest"
        value={v.retest}
        onChange={(x) => o.retest(x as RetestState)}
        placeholder="Retest"
        options={[
  ...
  return (
    <div data-testid="admin-audit-filters" className="contents">
      ...
      <FilterSelect
        ...
        value={v.recordKind}
        onChange={(x) => o.recordKind(x as AuditRecordKind)}
      ...
      <FilterSelect
        ariaLabel="Action"
        value={v.actionKind}
        onChange={(x) => o.actionKind(x as AuditActionKind)}
        placeholder="Action"
        options={[
          { v: "any", l: "All actions" },
          { v: "create", l: "Create" },
