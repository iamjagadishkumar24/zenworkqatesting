...
BEGIN
  ...
  -- All new signups receive the 'agent' role. Admin promotion is performed
  -- exclusively by an existing admin via public.change_user_role(). The
  -- previous "first signup becomes admin" bootstrap has been removed.
